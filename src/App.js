    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          consequat. testing testing mike 1,2,3 bvfvfvbjdshjk</p>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
          tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
          quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
          consequat.</p>
  ...
  <div className="row">
    <div className="col-md-3">
      <div className="card" style={{width: "18rem"}}>
        <img src="images/pizza8.jpeg" className="card-img-top img-fluid" alt="all season"/>
    ...
    <div className="col-md-3">
      <div className="card" style={{width: "18rem"}}>
        <img src="images/pizza3.jpeg" className="card-img-top img-fluid" alt="all season"/>
        <div className="card-body">
          <h3>Chicken Pizza</h3>
          <p className="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
          tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
    ...
    <div className="col-md-3">
      <div className="card" style={{width: "18rem"}}>
        <img src="images/pizza4.jpeg" className="card-img-top img-fluid" alt="all season"/>
        <div className="card-body">
    ...
    <div className="col-md-3">
      <div className="card" style={{width: "18rem"}}>
        <img src="images/pizza10.jpeg" className="card-img-top img-fluid" alt="all season"/>
        <div className="card-body">
